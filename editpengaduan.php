...
//             $sql = "SELECT laporan_pengaduan_pdf FROM tb_pengaduan WHERE id = '$id'";
...
//             $sql = "SELECT ktp_pdf FROM tb_pengaduan WHERE id = '$id'";
//             $result = $koneksi->query($sql);
//             if ($result->num_rows > 0) {
//                 $row = $result->fetch_assoc();
//                 $ktp_pdf = $row['ktp_pdf'];
...
//         $sql = "UPDATE tb_pengaduan SET user_id='$user_id', laporan_pengaduan_pdf='$laporan_pengaduan_pdf', ktp_pdf='$ktp_pdf', laporan_pengaduan='$laporan_pengaduan', ktp='$ktp', nama_pelapor='$nama_pelapor', no_hp='$no_hp', status='$status' WHERE id='$id'";
