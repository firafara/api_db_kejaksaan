...
//     if (isset($_POST['id']) && isset($_POST['user_id']) && isset($_POST['laporan_pengaduan']) && isset($_POST['status']) && isset($_FILES['ktp_pdf'])&& isset($_POST['ktp']) && isset($_POST['nama_pelapor']) && isset($_POST['no_hp'])) {
//         $id = $_POST['id'];
...
//             $sql = "SELECT laporan_pengaduan_pdf FROM tb_pengawasan WHERE id = '$id'";
...
//             $sql = "SELECT ktp_pdf FROM tb_pengawasan WHERE id = '$id'";
//             $result = $koneksi->query($sql);
//             if ($result->num_rows > 0) {
//                 $row = $result->fetch_assoc();
//                 $ktp_pdf = $row['ktp_pdf'];
...
//         $sql = "UPDATE tb_pengawasan SET user_id='$user_id', laporan_pengaduan_pdf='$laporan_pengaduan_pdf', ktp_pdf='$ktp_pdf', laporan_pengaduan='$laporan_pengaduan', ktp='$ktp', nama_pelapor='$nama_pelapor', no_hp='$no_hp', status='$status' WHERE id='$id'";
//         if ($koneksi->query($sql) === TRUE) {
//             $response['isSuccess'] = true;
//             $response['message'] = "Berhasil mengedit data pengawasan";
//         } else {
//             $response['isSuccess'] = false;
//             $response['message'] = "Gagal mengedit data pengawasan: " . $koneksi->error;
//         }
//     } else {
//         $response['isSuccess'] = false;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['id']) && isset($_POST['user_id']) && isset($_POST['laporan_pengaduan']) && isset($_POST['ktp']) && isset($_POST['nama_pelapor']) && isset($_POST['no_hp'])) {
        $id = $_POST['id'];
        $user_id = $_POST['user_id'];
        $laporan_pengaduan = $_POST['laporan_pengaduan'];
        $ktp = $_POST['ktp'];
