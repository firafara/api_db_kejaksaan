...
//             $sql = "SELECT laporan_pengaduan_pdf FROM tb_pilkada WHERE id = '$id'";
...
//             $sql = "SELECT ktp_pdf FROM tb_pilkada WHERE id = '$id'";
//             $result = $koneksi->query($sql);
//             if ($result->num_rows > 0) {
//                 $row = $result->fetch_assoc();
//                 $ktp_pdf = $row['ktp_pdf'];
...
//         $sql = "UPDATE tb_pilkada SET user_id='$user_id', laporan_pengaduan_pdf='$laporan_pengaduan_pdf', ktp_pdf='$ktp_pdf', laporan_pengaduan='$laporan_pengaduan', ktp='$ktp', nama_pelapor='$nama_pelapor', no_hp='$no_hp', status='$status' WHERE id='$id'";
//         if ($koneksi->query($sql) === TRUE) {
//             $response['isSuccess'] = true;
//             $response['message'] = "Berhasil mengedit data pilkada";
//         } else {
//             $response['isSuccess'] = false;
//             $response['message'] = "Gagal mengedit data pilkada: " . $koneksi->error;
//         }
//     } else {
//         $response['isSuccess'] = false;
